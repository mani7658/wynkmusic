...
public class PaymentController {
	...
	public String createOrder(HttpSession session) {
		...
		Order order=null;
		try {
			RazorpayClient razorpay=new RazorpayClient("rzp_test_WfKDmK9slhYcwJ", 
					"7tdCBW7CxOVcCheiIKJ2U6s1");
	...
	public boolean verifyPayment(@RequestParam  String orderId, @RequestParam String paymentId,
		...
		try {
			...
			RazorpayClient razorpayClient = new RazorpayClient("rzp_test_WfKDmK9slhYcwJ", 
					"7tdCBW7CxOVcCheiIKJ2U6s1");
